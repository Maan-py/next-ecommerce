        ...
        <form action={formAction} className="w-[500px] bg-white p-[50px_30px] flex flex-col gap-5 rounded-3xl border border-[#E5E5E5]">
          ...
          <div className="flex flex-col gap-[10px]">
            <div className="flex items-center gap-[10px] rounded-full border border-[#E5E5E5] p-[12px_20px] focus-within:ring-2 focus-within:ring-[#FFC736] transition-all duration-300">
              ...
              />
              <button type="button" className="reveal-password flex shrink-0 cursor-pointer">
                <img onClick={() => setIsVisible(!isVisible)} src="/assets/icons/eye.svg" alt="icon" />
              </button>
            </div>
          ...
          <div className="flex flex-col gap-3">
            <SubmitButton />
            <Link href="/sign-in" className="p-[12px_24px] bg-[#EFF3FA] rounded-full text-center font-semibold border border-white">
              Sign In
            </Link>
          </div>
        </form>
